<template>
  <div class="port-url-container">
    ...
    <div class="search-box">
      <el-form :inline="true" :model="queryParams" class="demo-form-inline">
        <el-form-item label="端口号">
          <el-input v-model="queryParams.number" placeholder="输入端口号" clearable></el-input>
        </el-form-item>
        <el-form-item>
    ...
    <!-- 数据表格 -->
    <el-table :data="portList" v-loading="loading" border style="width: 100%">
      <el-table-column prop="id" label="ID" width="80"></el-table-column>
      <el-table-column prop="number" label="端口号" min-width="150"></el-table-column>
      ...
      <div class="drawer-content">
        ...
        >
          <el-form-item label="端口号" prop="number">
            <el-input v-model="form.number" placeholder="请输入端口号" maxlength="10" show-word-limit></el-input>
    ...
    >
      <template #default>
        <div class="description-drawer-content" v-if="currentPort">
          <div class="description-body">
            <markdown-view
              :content="currentPort.description || '暂无描述'"
              :theme="editorTheme"
              :show-catalog="true"
              :catalog-level="3"
            />
...
.port-url-container {
  ...
  .port-form {
    ...
    .el-textarea__inner:focus {
      border-color: var(--vue-color-primary);
